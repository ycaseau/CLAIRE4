// --- System configuration file for "claire4" , ["Saturday 08-17-2024"] ---
...
func Load() { 
  ...
  Core.It = InitModule("Core",C_mClaire,MakeConstantList(C_Kernel.Id()),
  	"/Users/ycaseau/Dropbox/src/clairev4.12/src/meta",
  ...
  Optimize.It = InitModule("Optimize",Optimize.C_Compile,MakeConstantList(C_mClaire.Id(),Reader.It.Id()),
  	"/Users/ycaseau/Dropbox/src/clairev4.12/src/compile",
