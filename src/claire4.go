// --- System configuration file for "claire4" , ["Saturday 01-21-2023"] ---
...
func Load() { 
  ...
  Core.It = InitModule("Core",C_mClaire,MakeConstantList(C_Kernel.Id()),
  	"/Users/ycaseau/Dropbox/src/clairev4.07/src/meta",
  ...
  Optimize.It = InitModule("Optimize",Optimize.C_Compile,MakeConstantList(C_mClaire.Id(),Reader.It.Id()),
  	"/Users/ycaseau/Dropbox/src/clairev4.07/src/compile",
