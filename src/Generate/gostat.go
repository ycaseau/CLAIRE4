  ...
  { var lbad *ClaireList
    ...
    { 
      ...
      for CLcount := 0; CLcount < v_list2.Length(); CLcount++{ 
        i = ToInteger(v_list2.At(CLcount)).Value
        var try_6 EID
...
func F_Generate_statement_any (self *ClaireAny,s *ClaireClass,v *ClaireString,loop *ClaireAny) EID { 
  ...
  if (g0161I == CTRUE) { 
    ...
    { 
      ...
      v_and2 = Core.F__I_equal_any(s.Id(),C_void.Id())
      if (v_and2 == CFALSE) {try_2 = EID{CFALSE.Id(),0}
      } else { 
        var try_3 EID
  ...
  { var v *ClaireVariable = self.ClaireVar
    { var y *ClaireAny = self.Arg
      { 
        ...
        { 
          ...
          { 
            ...
            if (v_or5 == CTRUE) {try_2 = EID{CTRUE.Id(),0}
              ...
              v_or5 = F_Generate_eid_provide_ask_any(self.Value)
              if (v_or5 == CTRUE) {try_2 = EID{CTRUE.Id(),0}
              } else { 
          ...
          if (v_and4 == CFALSE) {try_1 = EID{CFALSE.Id(),0}
            ...
            v_and4 = Equal(MakeInteger(Language.F_occurrence_any(self.Arg,self.ClaireVar)).Id(),MakeInteger(1).Id())
            if (v_and4 == CFALSE) {try_1 = EID{CFALSE.Id(),0}
            } else { 
              var try_4 EID
        ...
        v_or3 = ToBoolean(OBJ(try_1))
        if (v_or3 == CTRUE) {Result = EID{CTRUE.Id(),0}
        } else { 
          v_or3 = Equal(v.Range.Id(),Optimize.C_EID.Id())
          if (v_or3 == CTRUE) {Result = EID{CTRUE.Id(),0}
          } else { 
            Result = EID{CFALSE.Id(),0}} 
          } 
  ...
  { var try_ask *ClaireBoolean
    ...
    if ((Equal(self.Other,CNIL.Id()) == CTRUE) || 
      ...
      { 
        ...
        v_and3 = self.Other.Isa.IsIn(Language.C_If)
  ...
  { 
    ...
    if (v_and1 == CFALSE) {try_1 = EID{CFALSE.Id(),0}
      ...
      if (v_and1 == CFALSE) {try_1 = EID{CFALSE.Id(),0}
        ...
        v_and1 = MakeBoolean((smember.Id() != C_any.Id()) && (sbag.Id() == C_list.Id()))
        if (v_and1 == CFALSE) {try_1 = EID{CFALSE.Id(),0}
        } else { 
          try_1 = EID{CTRUE.Id(),0}} 
        } 
            ...
            { var _CL_obj *Language.Call = Language.To_Call(new(Language.Call).Is(Language.C_Call))
              ...
              { 
                ...
                { 
                  ...
                  v_list8 = l
                  try_5 = EID{CreateList(ToType(CEMPTY.Id()),v_list8.Length()).Id(),0}
                  for CLcount := 0; CLcount < v_list8.Length(); CLcount++{ 
                    ...
                    v_local8 = ANY(try_6)
                    ToList(OBJ(try_5)).PutAt(CLcount,v_local8)
                    } 
                  }
                  } 
                if ErrorIn(try_5) {try_4 = try_5
      ...
      { var sr *ClaireType
        ...
        if (g0195I == CTRUE) { 
          ...
          { 
            ...
            v_and5 = ToBoolean(OBJ(try_6))
            if (v_and5 == CFALSE) {try_5 = EID{CFALSE.Id(),0}
            } else { 
              var try_7 EID
              ...
              if (v_and5 == CFALSE) {try_5 = EID{CFALSE.Id(),0}
                ...
                v_and5 = Optimize.F_Compile_update_write_ask_Update(self)
                if (v_and5 == CFALSE) {try_5 = EID{CFALSE.Id(),0}
                } else { 
