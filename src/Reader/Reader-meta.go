...
func MetaLoad() { 
  ...
  It.Comment = MakeString("Compiled on Wednesday 01-01-2025 17:30:04(v4.1.4), lines:1794, warnings:3,safety:5")
  ClEnv.Module_I = It
  ...
  _ = Core.F_attach_method(C_Reader_top_level.AddMethod(Signature(C_meta_reader.Id(),C_void.Id()),1,MakeFunction1(E_Reader_top_level_meta_reader,"Reader_top_level_meta_reader")),MakeString("inspect.cl:85"))
  
  _ = Core.F_attach_method(C_Reader_debugLoop.AddMethod(Signature(C_meta_reader.Id(),C_void.Id()),0,MakeFunction1(E_Reader_debugLoop_meta_reader,"Reader_debugLoop_meta_reader")),MakeString("inspect.cl:95"))
  
  _ = Core.F_attach_method(C_Reader_inspect_system.AddMethod(Signature(C_list.Id(),C_void.Id()),0,MakeFunction1(E_Reader_inspect_system_list2,"Reader_inspect_system_list2")),MakeString("inspect.cl:101"))
  
  _ = Core.F_attach_method(C_Reader_simple_main.AddMethod(Signature(C_void.Id(),C_void.Id()),1,MakeFunction1(E_Reader_simple_main_void,"Reader_simple_main_void")),MakeString("inspect.cl:106"))
  
  _ = Core.F_attach_method(C_inspect.AddMethod(Signature(C_any.Id(),C_any.Id()),1,MakeFunction1(E_inspect_any,"inspect_any")),MakeString("inspect.cl:132"))
  
  _ = Core.F_attach_method(C_inspect_loop.AddMethod(Signature(C_any.Id(),C_list.Id(),C_void.Id()),1,MakeFunction2(E_inspect_loop_any,"inspect_loop_any")),MakeString("inspect.cl:153"))
  
  _ = Core.F_attach_method(C_get_from_integer.AddMethod(Signature(C_any.Id(),C_integer.Id(),C_any.Id()),1,MakeFunction2(E_get_from_integer_any,"get_from_integer_any")),MakeString("inspect.cl:164"))
  
  _ = Core.F_attach_method(Language.C_iClaire_trace_on.AddMethod(Signature(C_any.Id(),C_any.Id()),1,MakeFunction1(E_trace_on_any,"trace_on_any")),MakeString("inspect.cl:186"))
  
  _ = Core.F_attach_method(C_Reader_untrace.AddMethod(Signature(C_any.Id(),C_any.Id()),1,MakeFunction1(E_untrace_any,"untrace_any")),MakeString("inspect.cl:198"))
  
  _ = Core.F_attach_method(Core.C_spy.AddMethod(Signature(C_listargs.Id(),C_void.Id()),0,MakeFunction1(E_spy_listargs2_Reader,"spy_listargs2_Reader")),MakeString("inspect.cl:206"))
  ...
  _ = Core.F_attach_method(C_Reader_trace_rule.AddMethod(Signature(C_relation.Id(),
    ...
    C_any.Id(),
    C_any.Id(),
    C_void.Id()),1,MakeFunction6(E_trace_rule_relation,"trace_rule_relation")),MakeString("inspect.cl:216"))
  
  _ = Core.F_attach_method(C_Reader_stop.AddMethod(Signature(C_property.Id(),C_listargs.Id(),C_any.Id()),1,MakeFunction2(E_stop_property,"stop_property")),MakeString("inspect.cl:224"))
  
  _ = Core.F_attach_method(Core.C_debug.AddMethod(Signature(C_void.Id(),C_void.Id()),0,MakeFunction1(E_debug_void,"debug_void")),MakeString("inspect.cl:238"))
  
  _ = Core.F_attach_method(C_call_debug.AddMethod(Signature(C_void.Id(),C_any.Id()),0,MakeFunction1(E_call_debug_void,"call_debug_void")),MakeString("inspect.cl:259"))
  
  _ = Core.F_attach_method(C_Reader_breakpoint.AddMethod(Signature(C_void.Id(),C_void.Id()),1,MakeFunction1(E_breakpoint_void,"breakpoint_void")),MakeString("inspect.cl:284"))
  ...
  _ = Core.F_attach_method(C_dn.AddMethod(Signature(C_integer.Id(),C_void.Id()),0,MakeFunction1(E_dn_integer,"dn_integer")),MakeString("inspect.cl:294"))
  
  _ = Core.F_attach_method(C_up.AddMethod(Signature(C_integer.Id(),C_void.Id()),0,MakeFunction1(E_up_integer,"up_integer")),MakeString("inspect.cl:303"))
  
  _ = Core.F_attach_method(C_where.AddMethod(Signature(C_integer.Id(),C_void.Id()),1,MakeFunction1(E_where_integer,"where_integer")),MakeString("inspect.cl:313"))
  
  _ = Core.F_attach_method(C_Reader_print_debug_info.AddMethod(Signature(C_integer.Id(),
    C_integer.Id(),
    C_integer.Id(),
    C_void.Id()),1,MakeFunction3(E_print_debug_info_integer,"print_debug_info_integer")),MakeString("inspect.cl:325"))
  
  _ = Core.F_attach_method(C_Reader_Show.AddMethod(Signature(C_integer.Id(),C_any.Id()),1,MakeFunction1(E_Show_integer,"Show_integer")),MakeString("inspect.cl:338"))
  
  _ = Core.F_attach_method(C_block.AddMethod(Signature(C_integer.Id(),C_void.Id()),1,MakeFunction1(E_block_integer,"block_integer")),MakeString("inspect.cl:363"))
  
  _ = Core.F_attach_method(C_Reader_closure_build.AddMethod(Signature(C_lambda.Id(),C_list.Id()),0,MakeFunction1(E_closure_build_lambda,"closure_build_lambda")),MakeString("inspect.cl:371"))
  
  _ = Core.F_attach_method(C_Reader_closure_build.AddMethod(Signature(C_any.Id(),C_list.Id(),C_void.Id()),0,MakeFunction2(E_closure_build_any,"closure_build_any")),MakeString("inspect.cl:382"))
  ...
  _ = Core.F_attach_method(C_close.AddMethod(Signature(C_measure.Id(),C_measure.Id()),0,MakeFunction1(E_close_measure,"close_measure")),MakeString("inspect.cl:399"))
  
  _ = Core.F_attach_method(C_add.AddMethod(Signature(C_measure.Id(),C_float.Id(),C_measure.Id()),0,MakeFunction2(E_add_measure,"add_measure")),MakeString("inspect.cl:401"))
  
  _ = Core.F_attach_method(C_mean.AddMethod(Signature(C_measure.Id(),C_float.Id()),0,MakeFunction1(E_mean_measure,"mean_measure")),MakeString("inspect.cl:403"))
  
  _ = Core.F_attach_method(C_stdev.AddMethod(Signature(C_measure.Id(),C_float.Id()),0,MakeFunction1(E_stdev_measure,"stdev_measure")),MakeString("inspect.cl:406"))
  
  _ = Core.F_attach_method(C_stdev_Z.AddMethod(Signature(C_measure.Id(),C_float.Id()),0,MakeFunction1(E_stdev_Z_measure,"stdev_Z_measure")),MakeString("inspect.cl:407"))
  
  _ = Core.F_attach_method(C_reset.AddMethod(Signature(C_measure.Id(),C_void.Id()),0,MakeFunction1(E_reset_measure,"reset_measure")),MakeString("inspect.cl:408"))
  
  _ = Core.F_attach_method(C_self_print.AddMethod(Signature(C_measure.Id(),C_void.Id()),1,MakeFunction1(E_self_print_measure_Reader,"self_print_measure_Reader")),MakeString("inspect.cl:409"))
  
  _ = Core.F_attach_method(C_logMeasure.AddMethod(Signature(C_string.Id(),C_void.Id()),1,MakeFunction1(E_logMeasure_string,"logMeasure_string")),MakeString("inspect.cl:421"))
  ...
  _ = Core.F_attach_method(C_addLog.AddMethod(Signature(C_integer.Id(),
    ...
    C_float.Id(),
    C_integer.Id(),
    C_void.Id()),1,MakeFunction5(E_addLog_integer,"addLog_integer")),MakeString("inspect.cl:428"))
