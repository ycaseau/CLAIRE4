...
func MetaLoad() { 
  ...
  _ = Core.F_attach_method(C_Reader_nexte.AddMethod(Signature(C_meta_reader.Id(),C_any.Id()),1,MakeFunction1(E_nexte_meta_reader,"nexte_meta_reader")),MakeString("read.cl:208"))
  
  _ = Core.F_attach_method(C_Reader_nextexp.AddMethod(Signature(C_meta_reader.Id(),C_boolean.Id(),C_any.Id()),1,MakeFunction2(E_nextexp_meta_reader,"nextexp_meta_reader")),MakeString("read.cl:256"))
  
  _ = Core.F_attach_method(C_Reader_nexti.AddMethod(Signature(C_meta_reader.Id(),C_any.Id(),C_any.Id()),1,MakeFunction2(E_nexti_meta_reader,"nexti_meta_reader")),MakeString("read.cl:305"))
  
  _ = Core.F_attach_method(C_Reader_read_escape.AddMethod(Signature(C_meta_reader.Id(),C_any.Id()),1,MakeFunction1(E_read_escape_meta_reader,"read_escape_meta_reader")),MakeString("read.cl:316"))
  
  _ = Core.F_attach_method(C_Reader_nextvariable.AddMethod(Signature(C_meta_reader.Id(),C_any.Id(),C_any.Id()),1,MakeFunction2(E_nextvariable_meta_reader,"nextvariable_meta_reader")),MakeString("read.cl:330"))
  
  _ = Core.F_attach_method(C_Reader_nexts_I.AddMethod(Signature(C_meta_reader.Id(),C_keyword.Id(),C_any.Id()),1,MakeFunction2(E_nexts_I_meta_reader1,"nexts_I_meta_reader1")),MakeString("read.cl:337"))
  
  _ = Core.F_attach_method(C_Reader_nexte_I.AddMethod(Signature(C_meta_reader.Id(),C_keyword.Id(),C_any.Id()),1,MakeFunction2(E_nexte_I_meta_reader,"nexte_I_meta_reader")),MakeString("read.cl:344"))
  
  _ = Core.F_attach_method(C_Reader_nexts_I.AddMethod(Signature(C_meta_reader.Id(),C_integer.Id(),C_any.Id()),1,MakeFunction2(E_nexts_I_meta_reader2,"nexts_I_meta_reader2")),MakeString("read.cl:350"))
  ...
  _ = Core.F_attach_method(C_Reader_extended_comment_ask.AddMethod(Signature(C_meta_reader.Id(),C_string.Id(),C_boolean.Id()),0,MakeFunction2(E_extended_comment_ask_meta_reader,"extended_comment_ask_meta_reader")),MakeString("read.cl:364"))
  
  _ = Core.F_attach_method(C_Reader_extended_comment_I.AddMethod(Signature(C_meta_reader.Id(),C_string.Id(),C_any.Id()),1,MakeFunction2(E_extended_comment_I_meta_reader,"extended_comment_I_meta_reader")),MakeString("read.cl:387"))
  ...
  _ = Core.F_attach_method(C_Reader_readlet.AddMethod(Signature(C_meta_reader.Id(),C_keyword.Id(),C_any.Id()),1,MakeFunction2(E_readlet_meta_reader,"readlet_meta_reader")),MakeString("syntax.cl:166"))
  ...
  _ = Core.F_attach_method(C_Reader_readwhen.AddMethod(Signature(C_meta_reader.Id(),C_keyword.Id(),C_any.Id()),1,MakeFunction2(E_readwhen_meta_reader,"readwhen_meta_reader")),MakeString("syntax.cl:192"))
  
  _ = Core.F_attach_method(C_Reader_readif.AddMethod(Signature(C_meta_reader.Id(),C_integer.Id(),C_any.Id()),1,MakeFunction2(E_readif_meta_reader,"readif_meta_reader")),MakeString("syntax.cl:206"))
  
  _ = Core.F_attach_method(C_Reader_readcase.AddMethod(Signature(C_meta_reader.Id(),C_keyword.Id(),C_any.Id()),1,MakeFunction2(E_readcase_meta_reader,"readcase_meta_reader")),MakeString("syntax.cl:224"))
  
  _ = Core.F_attach_method(C_Reader_readset.AddMethod(Signature(C_meta_reader.Id(),C_any.Id(),C_any.Id()),1,MakeFunction2(E_readset_meta_reader,"readset_meta_reader")),MakeString("syntax.cl:254"))
  
  _ = Core.F_attach_method(C_Reader_dereference.AddMethod(Signature(C_any.Id(),C_any.Id()),1,MakeFunction1(E_dereference_any,"dereference_any")),MakeString("syntax.cl:259"))
  
  _ = Core.F_attach_method(C_Reader_nextseq.AddMethod(Signature(C_meta_reader.Id(),C_integer.Id(),C_any.Id()),1,MakeFunction2(E_nextseq_meta_reader,"nextseq_meta_reader")),MakeString("syntax.cl:271"))
  ...
  _ = Core.F_attach_method(C_Reader_Do_I.AddMethod(Signature(C_any.Id(),C_any.Id(),C_any.Id()),1,MakeFunction2(E_Do_I_any,"Do_I_any")),MakeString("syntax.cl:295"))
  
  _ = Core.F_attach_method(C_Reader_extract_of_type.AddMethod(Signature(Language.C_Call.Id(),C_type.Id()),1,MakeFunction1(E_extract_of_type_Call,"extract_of_type_Call")),MakeString("syntax.cl:306"))
  ...
  /*any->any*/
  _ = Core.F_attach_method(C_Reader_DBregister.AddMethod(Signature(Language.C_Call.Id(),Language.C_Call.Id()),1,MakeFunction1(E_DBregister_Call,"DBregister_Call")),MakeString("syntax.cl:324"))
  
  _ = Core.F_attach_method(C_Reader_Call_I.AddMethod(Signature(C_property.Id(),C_list.Id(),Language.C_Call.Id()),1,MakeFunction2(E_Call_I_property,"Call_I_property")),MakeString("syntax.cl:326"))
  ...
  _ = Core.F_attach_method(C_Reader_nextinst.AddMethod(Signature(C_meta_reader.Id(),C_any.Id(),C_any.Id()),1,MakeFunction2(E_nextinst_meta_reader,"nextinst_meta_reader")),MakeString("syntax.cl:434"))
  ...
  _ = Core.F_attach_method(C_read.AddMethod(Signature(C_string.Id(),C_any.Id()),1,MakeFunction1(E_read_string,"read_string")),MakeString("file.cl:327"))
  ...
  /*any->any*/
  _ = Core.F_attach_method(C_Reader_debug_if_possible.AddMethod(Signature(C_void.Id(),C_any.Id()),1,MakeFunction1(E_debug_if_possible_void,"debug_if_possible_void")),MakeString("file.cl:339"))
  
  _ = Core.F_attach_method(C_Reader_print_exception.AddMethod(Signature(C_void.Id(),C_any.Id()),0,MakeFunction1(E_print_exception_void,"print_exception_void")),MakeString("file.cl:353"))
  
  C_pretty_show = MakeProperty("pretty_show",3,C_claire)
  C_pretty_show.Open = 3
  /*integer->integer*/
  
  _ = Core.F_attach_method(C_show.AddMethod(Signature(C_any.Id(),C_any.Id()),1,MakeFunction1(E_show_any,"show_any")),MakeString("file.cl:372"))
  
  _ = Core.F_attach_method(C_kill.AddMethod(Signature(C_object.Id(),C_any.Id()),0,MakeFunction1(E_kill_object,"kill_object")),MakeString("file.cl:380"))
  
  _ = Core.F_attach_method(C_kill.AddMethod(Signature(C_class.Id(),C_any.Id()),0,MakeFunction1(E_kill_class,"kill_class")),MakeString("file.cl:385"))
  ...
  _ = Core.F_attach_method(C_float_I.AddMethod(Signature(C_string.Id(),C_float.Id()),1,MakeFunction1(E_float_I_string,"float_I_string")),MakeString("file.cl:405"))
