/***** CLAIRE Compilation of file /Users/ycaseau/Dropbox/src/clairev4.12/src/meta/object.cl 
    ...
    { var n int = ClEnv.Trace_I
      ...
      if (F_get_table(C_Core_StopProperty,prop.Id()) != CNULL) { 
        ...
        { 
          ...
          v_or4 = Equal(F_get_table(C_Core_StopProperty,prop.Id()),CNIL.Id())
                        ...
                        for (j <= g0059) { 
                          ...
                          { var arg_12 *ClaireBoolean
                            ...
                            { 
                              ...
                              v_and14 = F__inf_equal_integer((j+start),i)
                              if (v_and14 == CFALSE) {try_13 = EID{CFALSE.Id(),0}
                              } else { 
                                var try_14 EID
  ...
  { var n int = self.Index
    ...
    { var arg_1 *ClaireString
      if (n == 1) { 
        ...
        arg_1 = MakeString("Cannot create a string with negative length ~S")
        }  else if (n == 23) { 
        arg_1 = MakeString("Not enough memory to install claire")
        }  else if (n == 24) { 
