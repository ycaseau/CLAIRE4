/***** CLAIRE Compilation of file /Users/ycaseau/Dropbox/src/clairev4.10/src/compile/ocontrol.cl 
          ...
          { var prop *ClaireAny
            ...
            if (C_slot.Id() == prop.Isa.Id()) { 
              ...
              { var g0249 *ClaireMethod = ToMethod(prop)
                Result = F_Optimize_c_code_method_method1(g0249,l,_Ztype)
                } 
              } else {
    ...
    { var a *ClaireList = self.Args
      ...
      if (g0251I == CTRUE) { 
        ...
        { 
          ...
          if (v_and4 == CFALSE) {g0252I = CFALSE
          } else { 
