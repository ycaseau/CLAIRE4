/***** CLAIRE Compilation of file /Users/ycaseau/Dropbox/src/clairev4.03/src/compile/odefine.cl 
...
/* {1} The go function for: c_type(self:List) [status=1] */
...
/* {1} The go function for: c_code(self:List) [status=1] */
func F_c_code_List (self *Language.List ) EID { 
    ...
    { var x *Language.List  
      ...
      { var _CL_obj *Language.List   = Language.To_List(new(Language.List).Is(Language.C_List))
        ...
        { 
          ...
          { 
            ...
            v_list5 = self.Args
            try_2 = EID{CreateList(ToType(CEMPTY.Id()),v_list5.Length()).Id(),0}
            for CLcount := 0; CLcount < v_list5.Length(); CLcount++{ 
              ...
              /* ERROR PROTECTION INSERTED (v_local5-try_2) */
      ...
      if (self.Of.Id() != CNULL) { 
        ...
        /*g_try(v2:"try_4",loop:false) */
        { 
          /* Or stat: v="try_4", loop=false */
          var v_or4 *ClaireBoolean  
          
          /* Or stat: try > @ integer(safety @ meta_compiler(compiler),4) with try:false, v="try_4", loop=false */
          v_or4 = Core.F__sup_integer(C_compiler.Safety,4)
          if (v_or4 == CTRUE) {try_4 = EID{CTRUE.Id(),0}
          } else { 
            /* Or stat: try = @ any(of @ List(self),{}) with try:false, v="try_4", loop=false */
            v_or4 = Equal(self.Of.Id(),CEMPTY.Id())
            if (v_or4 == CTRUE) {try_4 = EID{CTRUE.Id(),0}
            } else { 
              /* Or stat: try not @ any(for %x:any in (args @ Construct(self)) (if (not @ any(<= @ type_expression(c_type(%x),of @ List(self)))) break(true) else false)) with try:true, v="try_4", loop=false */
              var try_5 EID 
              ...
              { var arg_6 *ClaireAny  
                ...
                { 
                  ...
                  for i_it := 0; i_it < _Zx_len; i_it++ { 
                    ...
                    /* ERROR PROTECTION INSERTED (g0287I-loop_8) */
                    if ErrorIn(try_9) {loop_8 = try_9
                    } else {
                    g0287I = ToBoolean(OBJ(try_9))
                    if (g0287I == CTRUE) { 
              ...
              /* ERROR PROTECTION INSERTED (v_or4-try_4) */
              if ErrorIn(try_5) {try_4 = try_5
              } else {
              v_or4 = ToBoolean(OBJ(try_5))
              if (v_or4 == CTRUE) {try_4 = EID{CTRUE.Id(),0}
              } else { 
        ...
        /* ERROR PROTECTION INSERTED (g0286I-Result) */
        if ErrorIn(try_4) {Result = try_4
        } else {
        g0286I = ToBoolean(OBJ(try_4))
        if (g0286I == CTRUE) { 
          x.Of = self.Of
          ...
          { var arg_14 *ClaireList  
            ...
            { 
              ...
              { 
                ...
                v_list7 = self.Args
                try_16 = EID{CreateList(ToType(CEMPTY.Id()),v_list7.Length()).Id(),0}
                for CLcount := 0; CLcount < v_list7.Length(); CLcount++{ 
                  _Zx = v_list7.At(CLcount)
                  var try_17 EID 
                  /*g_try(v2:"try_17",loop:tuple("try_16", EID)) */
                  try_17 = Core.F_CALL(C_c_type,ARGS(_Zx.ToEID()))
                  /* ERROR PROTECTION INSERTED (v_local7-try_16) */
                  if ErrorIn(try_17) {try_16 = try_17
                  break
                  } else {
                  v_local7 = ANY(try_17)
                  ToList(OBJ(try_16)).PutAt(CLcount,v_local7)
                  } 
                }
                } 
          ...
          { var arg_18 *Language.Call  
            ...
            { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
              ...
              /*property->property*/_CL_obj.Args = MakeConstantList(x.Id(),C_list.Id(),self.Of.Id())
              /*list->list*/arg_18 = _CL_obj
              } 
...
/* {1} The go function for: c_type(self:Set) [status=1] */
...
/* {1} The go function for: c_code(self:Set) [status=1] */
      ...
      if (self.Of.Id() != CNULL) { 
        ...
        { 
          ...
          if (v_or4 == CTRUE) {try_4 = EID{CTRUE.Id(),0}
            ...
            /* Or stat: try = @ any(of @ Set(self),{}) with try:false, v="try_4", loop=false */
            v_or4 = Equal(self.Of.Id(),CEMPTY.Id())
            if (v_or4 == CTRUE) {try_4 = EID{CTRUE.Id(),0}
            } else { 
              /* Or stat: try not @ any(for %x:any in (args @ Construct(self)) (if (not @ any(<= @ type_expression(c_type(%x),of @ Set(self)))) break(true) else false)) with try:true, v="try_4", loop=false */
              var try_5 EID 
              /*g_try(v2:"try_5",loop:false) */
              { var arg_6 *ClaireAny  
                _ = arg_6
                ...
                { 
                  ...
                  for i_it := 0; i_it < _Zx_len; i_it++ { 
                    ...
                    /* ERROR PROTECTION INSERTED (g0289I-loop_8) */
                    if ErrorIn(try_9) {loop_8 = try_9
                    } else {
                    g0289I = ToBoolean(OBJ(try_9))
                    if (g0289I == CTRUE) { 
                      try_7 = EID{CTRUE.Id(),0}
                      break
                      } else {
        ...
        /* ERROR PROTECTION INSERTED (g0288I-Result) */
        if ErrorIn(try_4) {Result = try_4
        } else {
        g0288I = ToBoolean(OBJ(try_4))
        if (g0288I == CTRUE) { 
          x.Of = self.Of
          /*type->type*/Result = EID{x.Id(),0}
          } else {
          ...
          { var arg_18 *Language.Call  
            ...
            { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
              _CL_obj.Selector = Core.C_check_in
              /*property->property*/_CL_obj.Args = MakeConstantList(x.Id(),C_set.Id(),self.Of.Id())
              /*list->list*/arg_18 = _CL_obj
              } 
...
/* {1} The go function for: c_type(self:Tuple) [status=1] */
...
/* {1} The go function for: c_code(self:Tuple) [status=1] */
...
/* {1} The go function for: c_type(self:Map) [status=0] */
...
/* {1} The go function for: c_code(self:Map) [status=1] */
          ...
          { 
            ...
            { var arg_4 *Language.Call  
              ...
              { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                ...
                /*property->property*/_CL_obj.Args = MakeConstantList(self.Domain.Id(),self.Of.Id())
                /*list->list*/arg_4 = _CL_obj
                } 
              ...
              { 
                ...
                { var arg_5 *ClaireList  
                  ...
                  { 
                    ...
                    v_list9 = self.Args
                    arg_5 = CreateList(ToType(CEMPTY.Id()),v_list9.Length())
                    for CLcount := 0; CLcount < v_list9.Length(); CLcount++{ 
                      x = v_list9.At(CLcount)
                      { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                        _CL_obj.Selector = C_put
                        /*property->property*/_CL_obj.Args = MakeConstantList(_Zv.Id(),ToPair(x).First,ToPair(x).Second)
                        /*list->list*/v_local9 = _CL_obj.Id()
                        } 
                      arg_5.PutAt(CLcount,v_local9)
                      } 
                    } 
                  va_arg2 = arg_5.AddFast(_Zv.Id())/*t=any,s=list*/
                  } 
                va_arg1.Args = va_arg2
                /*list->list*/} 
              va_arg2 = _CL_obj.Id()
...
// ******************************************************************
/* {1} The go function for: c_type(self:Definition) [status=0] */
...
/* {1} The go function for: c_code(self:Definition,s:class) [status=1] */
        ...
        { var _Zx *ClaireAny  
          ...
          if (F_boolean_I_any(_Zx) == CTRUE) { 
            ...
            { var arg_3 *Language.Let  
              ...
              { var _CL_obj *Language.Let   = Language.To_Let(new(Language.Let).Is(Language.C_Let))
                _CL_obj.ClaireVar = _Zv
                /*Variable->Variable*//*g_try(v2:"try_4",loop:false) */
                { 
                  var va_arg1 *Language.Let  
                  var va_arg2 *ClaireAny  
                  va_arg1 = _CL_obj
                    ...
                    { 
                      ...
                      { var arg_7 *Language.Call  
                        ...
                        { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                          ...
                          /*property->property*/_CL_obj.Args = MakeConstantList(_Zc.Id())
                ...
                { 
                  ...
                  { var _CL_obj *Language.Do   = Language.To_Do(new(Language.Do).Is(Language.C_Do))
                    ...
                    { 
                      ...
                      var try_9 EID 
                      /*g_try(v2:"try_9",loop:false) */
                      try_9 = F_Optimize_analyze_I_class(_Zc,_Zv.Id(),self.Args,ToType(CEMPTY.Id()).EmptyList())
                      /* ERROR PROTECTION INSERTED (va_arg2-try_8) */
                      if ErrorIn(try_9) {try_8 = try_9
                      } else {
                      va_arg2 = ToList(OBJ(try_9))
                      va_arg1.Args = va_arg2
                      /*list->list*/try_8 = EID{va_arg2.Id(),0}
                      }
                      } 
...
/* {1} The go function for: total?(self:class,l:list) [status=1] */
    ...
    { var lp *ClaireList  
      ...
      { var n int  = lp.Length()
        ...
        { 
          ...
          if (v_and4 == CFALSE) {g0293I = CFALSE
          } else { 
            { var arg_2 *ClaireAny  
              _ = arg_2
              { var i int  = 2
                { var g0291 int  = n
                  ...
                  for (i <= g0291) { 
                    ...
                    if (Equal(ANY(Core.F_CALL(C_selector,ARGS(lp.At(i-1).ToEID()))),Language.To_Call(l.At((i-1)-1)).Args.At(1-1)) != CTRUE) { 
                      arg_2 = CTRUE.Id()
                      break
                      } 
                    i = (i+1)
                    /* try?:false, v2:"v_while9" loop will be:tuple("arg_2", any) */
                    } 
                  } 
                } 
              v_and4 = Core.F_not_any(arg_2)
              } 
            if (v_and4 == CFALSE) {g0293I = CFALSE
            } else { 
                    ...
                    { var i int  = 2
                      { var g0292 int  = n
                        ...
                        for (i <= g0292) { 
                          ...
                          i = (i+1)
                          /* try?:false, v2:"v_while12" loop will be:tuple("arg_3", any) */
                          } 
                        } 
                      } 
                    v_and4 = Core.F_not_any(arg_3)
                    } 
                  if (v_and4 == CFALSE) {g0293I = CFALSE
                  } else { 
                    g0293I = CTRUE} 
              ...
              { 
                ...
                { var arg_6 *ClaireList  
                  ...
                  { 
                    ...
                    var v_local9 *ClaireAny  
                    v_list9 = l
                    try_7 = EID{CreateList(ToType(CEMPTY.Id()),v_list9.Length()).Id(),0}
                    for CLcount := 0; CLcount < v_list9.Length(); CLcount++{ 
                      x = v_list9.At(CLcount)
                      var try_8 EID 
                      /*g_try(v2:"try_8",loop:tuple("try_7", EID)) */
                      try_8 = Core.F_CALL(C_c_code,ARGS(ToList(OBJ(Core.F_CALL(C_args,ARGS(x.ToEID())))).At(2-1).ToEID(),EID{C_any.Id(),0}))
                      /* ERROR PROTECTION INSERTED (v_local9-try_7) */
                      if ErrorIn(try_8) {try_7 = try_8
                      break
                      } else {
                      v_local9 = ANY(try_8)
                      ToList(OBJ(try_7)).PutAt(CLcount,v_local9)
                      } 
                    }
                    } 
                  /* ERROR PROTECTION INSERTED (arg_6-try_5) */
            ...
            { var m *ClaireAny   = Core.F__at_property1(C_close,self).Id()
              ...
              if (F_boolean_I_any(m) == CTRUE) { 
                { var _CL_obj *Language.CallMethod1   = Language.To_CallMethod1(new(Language.CallMethod1).Is(Language.C_Call_method1))
                  ...
                  /*method->method*/_CL_obj.Args = MakeConstantList(_Zc)
...
/* {1} The go function for: analyze!(c:class,self:any,%l:list,lp:list) [status=1] */
    ...
    { var ins_ask *ClaireBoolean   = MakeBoolean(((c.Open == 3) || 
      ...
      { var r *ClaireList  
        ...
        { 
          ...
          var v_local4 *ClaireAny  
          v_list4 = _Zl
          try_1 = EID{CreateList(ToType(C_any.Id()),v_list4.Length()).Id(),0}
          for CLcount := 0; CLcount < v_list4.Length(); CLcount++{ 
            x = Language.To_Call(v_list4.At(CLcount))
            var try_2 EID 
            /*g_try(v2:"try_2",loop:tuple("try_1", EID)) */
            { var p *ClaireAny   = x.Args.At(1-1)
              { var y *ClaireAny   = x.Args.At(2-1)
                { var s *ClaireObject   = Core.F__at_property1(ToProperty(p),c)
                  { var special_ask *ClaireBoolean   = MakeBoolean(ANY(Core.F_CALL(C_open,ARGS(p.ToEID()))).IsInt(0) && (C_slot.Id() == s.Isa.Id()))
                    lp = lp.AddFast(p)/*t=any,s=list*/
                    /*g_try(v2:"try_2",loop:tuple("try_1", EID)) */
                    { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                      _CL_obj.Selector = ToProperty(IfThenElse((special_ask == CTRUE),
                        C_put.Id(),
                        Core.C_write.Id()))
                      /*property->property*//*g_try(v2:"try_2",loop:tuple("try_1", EID)) */
                      { 
                        var va_arg1 *Language.Call  
                        var va_arg2 *ClaireList  
                        va_arg1 = _CL_obj
                        ...
                        { 
                          ...
                          { 
                            ...
                            /* Or stat: try not @ any(special?) with try:false, v="try_5", loop=false */
                            v_or13 = special_ask.Not
                            if (v_or13 == CTRUE) {try_5 = EID{CTRUE.Id(),0}
                            } else { 
                              /* Or stat: try <= @ type_expression(c_type(y),<range(s):type_expression>) with try:true, v="try_5", loop=false */
                              var try_6 EID 
                              /*g_try(v2:"try_6",loop:false) */
                              { var arg_7 *ClaireType  
                                _ = arg_7
                              ...
                              /* ERROR PROTECTION INSERTED (v_or13-try_5) */
                              if ErrorIn(try_6) {try_5 = try_6
                              } else {
                              v_or13 = ToBoolean(OBJ(try_6))
                              if (v_or13 == CTRUE) {try_5 = EID{CTRUE.Id(),0}
                              } else { 
                          ...
                          /* ERROR PROTECTION INSERTED (g0294I-try_4) */
                          if ErrorIn(try_5) {try_4 = try_5
                          } else {
                          g0294I = ToBoolean(OBJ(try_5))
                          if (g0294I == CTRUE) { 
                            try_4 = y.ToEID()
                            } else {
              ...
              { var v *ClaireAny   = s.Default
                if ((v != CNULL) && 
                  ...
                  { var defExp *ClaireAny  
                    ...
                    /* ERROR PROTECTION INSERTED (g0295I-try_11) */
                    if ErrorIn(try_12) {try_11 = try_12
                    } else {
                    g0295I = ToBoolean(OBJ(try_12))
                    if (g0295I == CTRUE) { 
                      try_11 = v.ToEID()
                      } else {
                      { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                            ...
                            { var _CL_obj *Language.Cast   = Language.To_Cast(new(Language.Cast).Is(Language.C_Cast))
                              { 
                                ...
                                { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                                  ...
                                  /*property->property*/_CL_obj.Args = MakeConstantList(p.Id(),c.Id())
                    ...
                    /* ERROR PROTECTION INSERTED (defExp-loop_10) */
                    ...
                    { var arg_13 *Language.Call  
                      ...
                      { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                        ...
                        /*property->property*/_CL_obj.Args = MakeConstantList(p.Id(),self,defExp)
                        /*list->list*/arg_13 = _CL_obj
                        } 
                      r = r.AddFast(arg_13.Id())/*t=any,s=list*/
                      } 
                    loop_10 = EID{r.Id(),0}
                    }
                    } 
        ...
        { var m *ClaireAny   = Core.F__at_property1(C_close,c).Id()
          ...
          { var arg_14 *ClaireAny  
            ...
            if (F_boolean_I_any(m) == CTRUE) { 
              { var _CL_obj *Language.CallMethod1   = Language.To_CallMethod1(new(Language.CallMethod1).Is(Language.C_Call_method1))
                _CL_obj.Arg = ToMethod(m)
                /*method->method*/_CL_obj.Args = MakeConstantList(self)
                /*list->list*/arg_14 = _CL_obj.Id()
                } 
              } else {
              arg_14 = self
              } 
            r = r.AddFast(arg_14)/*t=any,s=list*/
            } 
          } 
        Result = EID{r.Id(),0}
        }
...
/* {1} The go function for: c_code(self:Defobj,s:class) [status=1] */
        ...
        { var _Zv *ClaireAny  
          if ((o != CNULL) && 
            ...
            { var arg_1 int 
              ...
              C_OPT.MaxVars = (C_OPT.MaxVars+1)
              /*integer->integer*/arg_1 = 0
              _Zv = F_Compile_Variable_I_symbol(ToSymbol(C_Compile__starname_star.Value),arg_1,_Zc.Id()).Id()
              } 
            } 
          { var _Zy1 *Language.Call  
            { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
              _CL_obj.Selector = C_Compile_object_I
              /*property->property*/_CL_obj.Args = MakeConstantList(self.Ident.Id(),_Zc.Id())
              /*list->list*/_Zy1 = _CL_obj
              } 
            { var _Zy2 *ClaireAny  
              var try_2 EID 
              /*g_try(v2:"try_2",loop:false) */
              try_2 = F_Optimize_analyze_I_class(_Zc,_Zv,self.Args,MakeConstantList(C_name.Id()))
              ...
              { var _Zx *ClaireAny  
                ...
                if (_Zv.Isa.IsIn(C_Variable) != CTRUE) { 
                  { var _CL_obj *Language.Do   = Language.To_Do(new(Language.Do).Is(Language.C_Do))
                    ...
                    /*list->list*/_Zx = _CL_obj.Id()
                    } 
                  } else {
                  { var _CL_obj *Language.Let   = Language.To_Let(new(Language.Let).Is(Language.C_Let))
                    _CL_obj.ClaireVar = To_Variable(_Zv)
                    /*Variable->Variable*/_CL_obj.Value = _Zy1.Id()
                    /*any->any*/{ 
                      var va_arg1 *Language.Let  
                      var va_arg2 *ClaireAny  
                      va_arg1 = _CL_obj
                ...
                if (o != CNULL) { 
                  if (ToBoolean(C_OPT.Objects.Contain_ask(o).Id()) != CTRUE) { 
                    C_OPT.Objects = C_OPT.Objects.AddFast(o)/*t=any,s=list*/
                    /*list->list*/Core.F_CALL(C_Optimize_c_register,ARGS(o.ToEID()))
                    } 
                  } else {
                  F_Compile_warn_void()
                ...
                try_3 = Core.F_CALL(C_c_code,ARGS(_Zx.ToEID(),EID{s.Id(),0}))
                /* ERROR PROTECTION INSERTED (_Zx-Result) */
...
// creation of a new named object
/* {1} The go function for: c_code(self:Defclass,s:class) [status=1] */
        ...
        { var _Zcreate *Language.Call  
          ...
          if (o != CNULL) { 
            { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
              ...
              /*property->property*/_CL_obj.Args = MakeConstantList(_Zname.Id(),self.Arg.Id())
                ...
                { var arg_4 *ClaireList  
                  ...
                  { var arg_6 *ClaireList  
                    ...
                    { 
                      ...
                      v_list10 = self.Args
                      try_8 = EID{CreateList(ToType(CEMPTY.Id()),v_list10.Length()).Id(),0}
                      for CLcount := 0; CLcount < v_list10.Length(); CLcount++{ 
                        x = v_list10.At(CLcount)
                        var try_9 EID 
                        /*g_try(v2:"try_9",loop:tuple("try_8", EID)) */
                        { var v *ClaireAny   = CNULL
                          _ = v
                          /*g_try(v2:"try_9",loop:tuple("try_8", EID)) */
                          if (x.Isa.IsIn(Language.C_Call) == CTRUE) { 
                            { var g0299 *Language.Call   = Language.To_Call(x)
                              _ = g0299
                              v = g0299.Args.At(2-1)
                              g0299 = Language.To_Call(g0299.Args.At(1-1))
                              x = g0299.Id()
                              try_9 = x.ToEID()
                              } 
                            }  else if (x.Isa.IsIn(C_Variable) == CTRUE) { 
                            { var g0300 *ClaireVariable   = To_Variable(x)
                              _ = g0300
                              var try_10 EID 
                              ...
                              { var arg_11 *ClaireAny  
                                ...
                                var try_12 EID 
                                /*g_try(v2:"try_12",loop:false) */
                                try_12 = Language.F_extract_type_any(g0300.Range.Id())
                              ...
                              /* ERROR PROTECTION INSERTED (v-try_9) */
                          ...
                          { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                            ...
                            /*property->property*//*g_try(v2:"try_9",loop:tuple("try_8", EID)) */
                            { 
                              var va_arg1 *Language.Call  
                              var va_arg2 *ClaireList  
                              va_arg1 = _CL_obj
                        ...
                        /* ERROR PROTECTION INSERTED (v_local10-try_8) */
                        if ErrorIn(try_9) {try_8 = try_9
                        break
                        } else {
                        v_local10 = ANY(try_9)
                        ToList(OBJ(try_8)).PutAt(CLcount,v_local10)
                        } 
                      }
                      } 
                    /* ERROR PROTECTION INSERTED (arg_6-try_5) */
                    ...
                    { var arg_7 *ClaireList  
                      ...
                      if (self.Params.Length() != 0) { 
                        { 
                          ...
                          { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                            _CL_obj.Selector = C_put
                            /*property->property*/_CL_obj.Args = MakeConstantList(C_params.Id(),o,self.Params.Id())
...
/* {1} The go function for: c_type(self:Defmethod) [status=0] */
...
/* {1} The go function for: c_code(self:Defmethod) [status=1] */
          ...
          { var ls *ClaireList  
            ...
            { var lrange *ClaireList  
              ...
              { 
                ...
                /* ERROR PROTECTION INSERTED (v_list7-try_2) */
                if ErrorIn(try_3) {try_2 = try_3
                } else {
                v_list7 = ToList(OBJ(try_3))
                try_2 = EID{CreateList(ToType(C_any.Id()),v_list7.Length()).Id(),0}
                for CLcount := 0; CLcount < v_list7.Length(); CLcount++{ 
                  x = v_list7.At(CLcount)
                  v_local7 = x
                  ToList(OBJ(try_2)).PutAt(CLcount,v_local7)
                  } 
                }
                } 
              ...
              { var sdef *ClaireAny  
                ...
                { var lbody *ClaireList  
                  ...
                  { var getm *ClaireObject   = ToObject(OBJ(Core.F_CALL(ToProperty(Core.C__at.Id()),ARGS(EID{px.Id(),0},ls.At(2-1).ToEID()))))
                    { var m *ClaireMethod  
                      var try_6 EID 
                      /*g_try(v2:"try_6",loop:false) */
                      if (C_method.Id() == getm.Isa.Id()) { 
                        { var g0301 *ClaireMethod   = ToMethod(getm.Id())
                          _ = g0301
                          try_6 = EID{g0301.Id(),0}
                          } 
                        } else {
                        try_6 = ToException(Core.C_general_error.Make(MakeString("[internal] the method ~S @ ~S is not known").Id(),MakeConstantList(px.Id(),ls.At(2-1)).Id())).Close()
                        } 
                      ...
                      if ((C_compiler.Inline_ask != CTRUE) && 
                        ...
                        { 
                          ...
                          if (v_and12 == CFALSE) {try_7 = EID{CFALSE.Id(),0}
                          } else { 
                            var try_8 EID 
                            /*g_try(v2:"try_8",loop:false) */
                            try_8 = F_Optimize_sort_pattern_ask_list(lv,self.Body)
                            /* ERROR PROTECTION INSERTED (v_and12-try_7) */
                            if ErrorIn(try_8) {try_7 = try_8
                            } else {
                            v_and12 = ToBoolean(OBJ(try_8))
                            if (v_and12 == CFALSE) {try_7 = EID{CFALSE.Id(),0}
                            } else { 
                              try_7 = EID{CTRUE.Id(),0}} 
                            } 
                        ...
                        /* ERROR PROTECTION INSERTED (g0303I-Result) */
                        if ErrorIn(try_7) {Result = try_7
                        } else {
                        g0303I = ToBoolean(OBJ(try_7))
                        if (g0303I == CTRUE) { 
                          ...
                          if (lbody.At(3-1) != C_body.Id()) { 
                            { var na *ClaireString  
                              var try_9 EID 
                              /*g_try(v2:"try_9",loop:false) */
                              try_9 = Core.F_CALL(C_Compile_function_name,ARGS(EID{px.Id(),0},ls.At(2-1).ToEID(),lbody.At(2-1).ToEID()))
                              ...
                              { var la *ClaireLambda  
                                ...
                                var try_10 EID 
                                /*g_try(v2:"try_10",loop:false) */
                                try_10 = Language.F_lambda_I_list(lv,lbody.At(3-1))
                                ...
                                { var news int 
                                  ...
                                  var try_11 EID 
                                  /*g_try(v2:"try_11",loop:false) */
                                  var g0304I *ClaireBoolean  
                                  var try_12 EID 
                                  /*g_try(v2:"try_12",loop:false) */
                                  if (C_OPT.Recompute == CTRUE) { 
                                    try_12 = F_Compile_g_throw_any(lbody.At(2-1))
                                    } else {
                                    try_12 = F_Compile_can_throw_ask_method(m)
                                    } 
                                  /* ERROR PROTECTION INSERTED (g0304I-try_11) */
                                  if ErrorIn(try_12) {try_11 = try_12
                                  } else {
                                  g0304I = ToBoolean(OBJ(try_12))
                                  if (g0304I == CTRUE) { 
                          ...
                          if (self.SetArg.Isa.IsIn(Core.C_global_variable) == CTRUE) { 
                            ToArray(lrange.Id()).NthPut(1,self.SetArg)
                              ...
                              (C_class.Id() != lrange.At(1-1).Isa.Id())) { 
                            ...
                            { var arg_14 *ClaireAny  
                              ...
                              if ((self.Inline_ask == CTRUE) && 
                                ...
                                { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                                  ...
                                  /*property->property*/_CL_obj.Args = MakeConstantList(_Zm,sdef)
                                  /*list->list*/try_15 = EID{_CL_obj.Id(),0}
                                  } 
                                }  else if (F_boolean_I_any(lrange.At(2-1)) == CTRUE) { 
                                { var na *ClaireString  
                                  var try_16 EID 
                                  /*g_try(v2:"try_16",loop:false) */
                                  { var arg_17 *ClaireAny  
                                    ...
                                    try_18 = Core.F_CALL(C_Compile_function_name,ARGS(EID{px.Id(),0},ls.At(2-1).ToEID(),lbody.At(2-1).ToEID()))
                                  ...
                                  /* ERROR PROTECTION INSERTED (na-try_15) */
                                  if ErrorIn(try_16) {try_15 = try_16
                                  } else {
                                  na = ToString(OBJ(try_16))
                                  { var _Zf *ClaireFunction   = F_make_function_string(na)
                                    /*g_try(v2:"try_15",loop:false) */
                                    try_15 = F_Compile_compile_lambda_string(na,ToLambda(lrange.At(2-1)),C_type.Id())
                                    /* ERROR PROTECTION INSERTED (try_15-try_15) */
                                    if !ErrorIn(try_15) {
                                    F_set_arity_function(_Zf,m.Domain.Length())
                                    { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                                      _CL_obj.Selector = Core.C_write
                                      /*property->property*/_CL_obj.Args = MakeConstantList(Language.C_iClaire_typing.Value,_Zm,_Zf.Id())
                                      /*list->list*/try_15 = EID{_CL_obj.Id(),0}
                                      } 
                                    }
                                    } 
...
/* {1} The go function for: type_extension(s:string) [status=0] */
...
/* {1} The go function for: sort_pattern?(lv:list,%body:any) [status=1] */
    ...
    { 
      ...
      if (v_and2 == CFALSE) {Result = EID{CFALSE.Id(),0}
        ...
        if (_Zbody.Isa.IsIn(Language.C_Call) == CTRUE) { 
          { var g0305 *Language.Call   = Language.To_Call(_Zbody)
            { 
              var v_and6 *ClaireBoolean  
              
              v_and6 = Equal(g0305.Selector.Id(),Core.C_sort.Id())
              if (v_and6 == CFALSE) {try_1 = EID{CFALSE.Id(),0}
              } else { 
                { var a1 *ClaireAny   = g0305.Args.At(1-1)
                  if (a1.Isa.IsIn(Language.C_Call) == CTRUE) { 
                    { var g0306 *Language.Call   = Language.To_Call(a1)
                      v_and6 = MakeBoolean((g0306.Selector.Id() == Core.C__at.Id()) && (g0306.Args.At(1-1).Isa.IsIn(C_property) == CTRUE))
                      } 
                    } else {
                    v_and6 = CFALSE
                    } 
                ...
                if (v_and6 == CFALSE) {try_1 = EID{CFALSE.Id(),0}
                  ...
                  { var arg_3 *ClaireAny  
                    ...
                    var try_4 EID 
                    /*g_try(v2:"try_4",loop:false) */
                    try_4 = Language.F_lexical_build_any(g0305.Args.At(2-1),lv,0)
                    /* ERROR PROTECTION INSERTED (arg_3-try_2) */
                    if ErrorIn(try_4) {try_2 = try_4
                    } else {
                    arg_3 = ANY(try_4)
                    try_2 = EID{Equal(arg_3,lv.At(1-1)).Id(),0}
                    }
                    } 
...
// quicksort (v3.3)
/* {1} The go function for: sort_code(self:Defmethod,lv:list) [status=1] */
                ...
                { var q *ClaireVariable   = F_Compile_Variable_I_symbol(Core.F_symbol_I_string2(MakeString("q")),0,C_integer.Id())
                  { var def1 *Language.Defmethod  
                    ...
                    { var _CL_obj *Language.Defmethod   = Language.To_Defmethod(new(Language.Defmethod).Is(Language.C_Defmethod))
                      ...
                      /*Call->Call*/_CL_obj.Inline_ask = CFALSE
                      /*boolean->boolean*/_CL_obj.SetArg = self.SetArg
                      /*any->any*/{ 
                          ...
                          /*property->property*/{ 
                            ...
                            { 
                              ...
                              { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                                ...
                                /*property->property*/_CL_obj.Args = MakeConstantList(lv.At(1-1))
                                /*list->list*/v_bag_arg = _CL_obj.Id()
                                } 
                              va_arg2.AddFast(v_bag_arg)
                              va_arg2.AddFast(l)} 
                      ...
                      { var _CL_obj *Language.If   = Language.To_If(new(Language.If).Is(Language.C_If))
                        { 
                          ...
                          { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                            ...
                            /*property->property*/_CL_obj.Args = MakeConstantList(m.Id(),n.Id())
                            /*list->list*/va_arg2 = _CL_obj.Id()
                            } 
                          ...
                          { var _CL_obj *Language.Let   = Language.To_Let(new(Language.Let).Is(Language.C_Let))
                            ...
                            /*Variable->Variable*/{ 
                              ...
                              { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                                ...
                                /*property->property*/_CL_obj.Args = MakeConstantList(l,n.Id())
                                /*list->list*/va_arg2 = _CL_obj.Id()
                                } 
                              va_arg1.Value = va_arg2
                              /*any->any*/} 
                                  ...
                                  /*property->property*/{ 
                                    ...
                                    { 
                                      ...
                                      { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                                        ...
                                        /*property->property*/_CL_obj.Args = MakeConstantList(n.Id(),MakeInteger(1).Id())
                                        /*list->list*/v_bag_arg = _CL_obj.Id()
                                        } 
                                      va_arg2.AddFast(v_bag_arg)} 
                                    va_arg1.Args = va_arg2
                                      ...
                                      { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                                        ...
                                        /*property->property*/{ 
                                          ...
                                          { 
                                            ...
                                            { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                                              _CL_obj.Selector = C_nth
                                              /*property->property*/_CL_obj.Args = MakeConstantList(l,m.Id())
                                              /*list->list*/v_bag_arg = _CL_obj.Id()
                                              } 
                                            va_arg2.AddFast(v_bag_arg)
                                      ...
                                      { var _CL_obj *Language.Do   = Language.To_Do(new(Language.Do).Is(Language.C_Do))
                                        { 
                                          ...
                                          { 
                                            ...
                                            { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                                              _CL_obj.Selector = C_nth_equal
                                              /*property->property*/_CL_obj.Args = MakeConstantList(l,m.Id(),x.Id())
                                              /*list->list*/v_bag_arg = _CL_obj.Id()
                                              } 
                                            va_arg2.AddFast(v_bag_arg)} 
                                          va_arg1.Args = va_arg2
                                  ...
                                  { var arg_3 *Language.Let  
                                    ...
                                    { var _CL_obj *Language.Let   = Language.To_Let(new(Language.Let).Is(Language.C_Let))
                                        ...
                                        { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                                          ...
                                          /*property->property*/{ 
                                            ...
                                            { 
                                              ...
                                              { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                                                _CL_obj.Selector = ToProperty(Core.C__plus.Id())
                                                /*property->property*/_CL_obj.Args = MakeConstantList(n.Id(),m.Id())
                                                /*list->list*/v_bag_arg = _CL_obj.Id()
                                                } 
                                              va_arg2.AddFast(v_bag_arg)
                                              va_arg2.AddFast(MakeInteger(1).Id())} 
                                      ...
                                      { 
                                        ...
                                        { var _CL_obj *Language.Let   = Language.To_Let(new(Language.Let).Is(Language.C_Let))
                                          _CL_obj.ClaireVar = q
                                          /*Variable->Variable*/_CL_obj.Value = n.Id()
                                          /*any->any*/{ 
                                            var va_arg1 *Language.Let  
                                            var va_arg2 *ClaireAny  
                                            va_arg1 = _CL_obj
                                              ...
                                              { 
                                                ...
                                                { 
                                                  ...
                                                  { var arg_4 *Language.Call  
                                                    ...
                                                    { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                                                      _CL_obj.Selector = C_nth
                                                      /*property->property*/_CL_obj.Args = MakeConstantList(l,p.Id())
                                                      /*list->list*/arg_4 = _CL_obj
                                                      } 
                                                  ...
                                                  { var _CL_obj *Language.If   = Language.To_If(new(Language.If).Is(Language.C_If))
                                                    { 
                                                      ...
                                                      { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                                                        ...
                                                        /*property->property*/_CL_obj.Args = MakeConstantList(p.Id(),n.Id())
                                                        /*list->list*/va_arg2 = _CL_obj.Id()
                                                        } 
                                                      va_arg1.Test = va_arg2
                                                      /*any->any*/} 
                                                  ...
                                                  { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                                                    _CL_obj.Selector = C_nth_equal
                                                    /*property->property*/_CL_obj.Args = MakeConstantList(l,n.Id(),x.Id())
                                                    /*list->list*/v_bag_arg = _CL_obj.Id()
                                                    } 
                                                  va_arg2.AddFast(v_bag_arg)
                                                  { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                      ...
                      { var def2 *Language.Defmethod  
                        { var _CL_obj *Language.Defmethod   = Language.To_Defmethod(new(Language.Defmethod).Is(Language.C_Defmethod))
                          { 
                            ...
                            { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                              _CL_obj.Selector = self.Arg.Selector
                              /*property->property*/_CL_obj.Args = MakeConstantList(n.Id(),m.Id(),l)
                              /*list->list*/va_arg2 = _CL_obj
                              } 
                            va_arg1.Arg = va_arg2
                            /*Call->Call*/} 
                          _CL_obj.Inline_ask = CFALSE
                          /*boolean->boolean*/_CL_obj.SetArg = self.SetArg
                          /*any->any*/_CL_obj.Body = _Zbd.Id()
                          /*any->any*/def2 = _CL_obj
                          } 
...
/* {1} The go function for: add_method(p:property,ls:list,rg:type,st:integer,f1:function,m:method) [status=0] */
...
func F_Optimize_add_method_I_method (m *ClaireMethod ,ls *ClaireList ,rg *ClaireAny ,stat *ClaireAny ,fu *ClaireFunction ) EID { 
    ...
    { 
      ...
      { var _CL_obj *Language.CallMethod   = Language.To_CallMethod(new(Language.CallMethod).Is(Language.C_Call_method))
        ...
        /*method->method*//*g_try(v2:"_Zc",loop:false) */
        { 
          ...
          /* ERROR PROTECTION INSERTED (va_arg2-_Zc) */
          if ErrorIn(try_1) {_Zc = try_1
          } else {
          va_arg2 = ToList(OBJ(try_1))
          va_arg1.Args = va_arg2
          /*list->list*/_Zc = EID{va_arg2.Id(),0}
          }
          } 
        /* ERROR PROTECTION INSERTED (_Zc-_Zc) */
        if !ErrorIn(_Zc) {
...
// list of patterns)
/* {1} The go function for: extract_signature!(l:list) [status=1] */
      ...
      { var l1 *ClaireList   = ToType(C_type_expression.Id()).EmptyList()
        ...
        { var l2 *ClaireList  
          ...
          { 
            ...
            var v_local5 *ClaireAny  
            v_list5 = l
            try_1 = EID{CreateList(ToType(C_any.Id()),v_list5.Length()).Id(),0}
            for CLcount := 0; CLcount < v_list5.Length(); CLcount++{ 
              v = To_Variable(v_list5.At(CLcount))
              var try_2 EID 
              /*g_try(v2:"try_2",loop:tuple("try_1", EID)) */
              { var p *ClaireAny  
                var try_3 EID 
                ...
                /* ERROR PROTECTION INSERTED (p-try_2) */
                if ErrorIn(try_3) {try_2 = try_3
                } else {
                p = ANY(try_3)
                n = (n+1)
                { var arg_4 *ClaireAny  
                  ...
                  l1 = l1.AddFast(arg_4)/*t=type_expression,s=list*/
                  } 
                v.Range = Language.F_type_I_any(p)
                /*type->type*/try_2 = p.ToEID()
                }
                } 
...
/* {1} The go function for: =sig?(x:list,y:list) [status=0] */
func F_Optimize__equalsig_ask_list (x *ClaireList ,y *ClaireList ) *ClaireBoolean  { 
    if ((Core.F_tmatch_ask_list(x,y) == CTRUE) && 
        (Core.F_tmatch_ask_list(y,x) == CTRUE)) {return CTRUE
    } else {return CFALSE}} 
...
//
/* {1} The go function for: Compile/function_name(p:property,l:list,x:any) [status=0] */
...
//
/* {1} The go function for: Compile/compile_lambda(self:string,l:lambda,m:any) [status=1] */
    ...
    { var x int  = C_compiler.Safety
      ...
      { var y *ClaireLambda   = l
        ...
        if (C_method.Id() == m.Isa.Id()) { 
          { var g0308 *ClaireMethod   = ToMethod(m)
            _ = g0308
            C_OPT.InMethod = g0308.Id()
            /*any->any*/} 
          } 
        if (C_OPT.LoopIndex > 0) { 
          ...
          /*integer->integer*/} 
        C_OPT.MaxVars = 0
        /*integer->integer*/if (ToBoolean(C_OPT.Unsure.Contain_ask(m).Id()) == CTRUE) { 
          C_compiler.Safety = 1
          /*integer->integer*/} 
        /*g_try(v2:"Result",loop:true) */
...
/* {1} The go function for: c_code(self:Defarray) [status=1] */
    ...
    { var a *ClaireList   = self.Arg.Args
      { var _Za *ClaireAny  
        ...
        { var arg_2 *ClaireSymbol  
          ...
          var try_3 EID 
          /*g_try(v2:"try_3",loop:false) */
          try_3 = Language.F_extract_symbol_any(a.At(1-1))
          /* ERROR PROTECTION INSERTED (arg_2-try_1) */
          if ErrorIn(try_3) {try_1 = try_3
          } else {
          arg_2 = ToSymbol(OBJ(try_3))
          try_1 = arg_2.Get().ToEID()
          }
          } 
        ...
        { var _Zv *ClaireTable  
          ...
          if (C_table.Id() == _Za.Isa.Id()) { 
            { var g0310 *ClaireTable   = ToTable(_Za)
              _ = g0310
              try_4 = EID{g0310.Id(),0}
              } 
            } else {
            try_4 = ToException(Core.C_general_error.Make(MakeString("[internal] the table ~S is unknown").Id(),MakeConstantList(a.At(1-1)).Id())).Close()
            } 
            ...
            { var e *ClaireAny  
              ...
              { var l *ClaireList  
                ...
                { var b *ClaireAny  
                  var try_7 EID 
                  /*g_try(v2:"try_7",loop:false) */
                  try_7 = Language.F_lexical_build_any(self.Body,l,0)
                  /* ERROR PROTECTION INSERTED (b-try_5) */
                  if ErrorIn(try_7) {try_5 = try_7
                  } else {
                  b = ANY(try_7)
                  var g0316I *ClaireBoolean  
                  { var arg_8 *ClaireAny  
                    _ = arg_8
                    { 
                      var va *ClaireAny  
                ...
                { var _Zl1 *ClaireList  
                  ...
                  if (ToRelation(_Za).Multivalued_ask == CTRUE) { 
                    { 
                      ...
                      { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                        _CL_obj.Selector = C_put
                        /*property->property*/_CL_obj.Args = MakeConstantList(C_multivalued_ask.Id(),_Zv.Id(),ToRelation(_Za).Multivalued_ask.Id())
                        /*list->list*/v_bag_arg = _CL_obj.Id()
                        } 
                  ...
                  { var _Zl2 *ClaireList  
                    ...
                    { 
                      ...
                      { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                        _CL_obj.Selector = C_put
                        /*property->property*/_CL_obj.Args = MakeConstantList(C_range.Id(),_Zv.Id(),ANY(Core.F_CALL(C_range,ARGS(_Za.ToEID()))))
                        /*list->list*/v_bag_arg = _CL_obj.Id()
                        } 
                      _Zl2.AddFast(v_bag_arg)
                      { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                        _CL_obj.Selector = C_put
                        /*property->property*/_CL_obj.Args = MakeConstantList(C_params.Id(),_Zv.Id(),ANY(Core.F_CALL(C_params,ARGS(_Za.ToEID()))))
                        /*list->list*/v_bag_arg = _CL_obj.Id()
                        } 
                      _Zl2.AddFast(v_bag_arg)
                      { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                        _CL_obj.Selector = C_put
                        /*property->property*/_CL_obj.Args = MakeConstantList(C_domain.Id(),_Zv.Id(),s.Id())
                        /*list->list*/v_bag_arg = _CL_obj.Id()
                        } 
                      _Zl2.AddFast(v_bag_arg)} 
                    /*g_try(v2:"Result",loop:true) */
                    { 
                      ...
                      var try_9 EID 
                      /*g_try(v2:"try_9",loop:false) */
                      try_9 = Language.F_extract_type_any(To_Variable(a.At(2-1)).Range.Id())
                      /* ERROR PROTECTION INSERTED (va_arg2-Result) */
                      if ErrorIn(try_9) {Result = try_9
                      } else {
                    ...
                    if (a.Length() == 2) { 
                      ...
                      { var arg_11 *Language.Call  
                        ...
                        if (s.Isa.IsIn(C_Interval) == CTRUE) { 
                          { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                            _CL_obj.Selector = C_put
                            /*property->property*//*g_try(v2:"try_12",loop:false) */
                            { 
                              var va_arg1 *Language.Call  
                              var va_arg2 *ClaireList  
                              va_arg1 = _CL_obj
                              ...
                              { 
                                ...
                                { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                                  ...
                                  /*property->property*//*g_try(v2:"try_14",loop:false) */
                                  { 
                                    var va_arg1 *Language.Call  
                                    var va_arg2 *ClaireList  
                                    va_arg1 = _CL_obj
                                    ...
                                    va_arg1.Args = va_arg2
                                    /*list->list*/try_14 = EID{va_arg2.Id(),0}
                                    }
                                    } 
                          ...
                          { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                            ...
                            /*property->property*/_CL_obj.Args = MakeConstantList(_Zv.Id())
                            /*list->list*/try_12 = EID{_CL_obj.Id(),0}
                            } 
                          } 
                        /* ERROR PROTECTION INSERTED (arg_11-try_10) */
                        if ErrorIn(try_12) {try_10 = try_12
                        ...
                        try_10 = EID{_Zl2.AddFast(arg_11.Id()).Id(),0}/*t=any,s=EID*/
                        }
                        } 
                      ...
                      { var arg_17 *ClaireObject  
                        _ = arg_17
                        if (e.Isa.IsIn(C_lambda) == CTRUE) { 
                          { var g0314 *ClaireLambda   = ToLambda(e)
                            _ = g0314
                            { var _CL_obj *Language.For   = Language.To_For(new(Language.For).Is(Language.C_For))
                              _CL_obj.ClaireVar = To_Variable(a.At(2-1))
                              /*Variable->Variable*/_CL_obj.SetArg = s.Id()
                              /*any->any*/{ 
                                var va_arg1 *Language.Iteration  
                                var va_arg2 *ClaireAny  
                                va_arg1 = Language.To_Iteration(_CL_obj.Id())
                                { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                                  _CL_obj.Selector = C_nth_equal
                                  /*property->property*/_CL_obj.Args = MakeConstantList(_Zv.Id(),a.At(2-1),g0314.Body)
                                  /*list->list*/va_arg2 = _CL_obj.Id()
                                  } 
                                va_arg1.Arg = va_arg2
                                /*any->any*/} 
                        ...
                        _Zl2 = _Zl2.AddFast(arg_17.Id())/*t=any,s=list*/
                        } 
                      Result = EID{_Zl2.Id(),0}
                      }
                      } else {
                      { var s1 *ClaireTypeExpression  
                        ...
                        var try_18 EID 
                        /*g_try(v2:"try_18",loop:false) */
                        try_18 = Language.F_extract_type_any(To_Variable(a.At(2-1)).Range.Id())
                        ...
                        { var s2 *ClaireTypeExpression  
                          ...
                          try_19 = Language.F_extract_type_any(To_Variable(a.At(3-1)).Range.Id())
                          ...
                          { var arg_20 *Language.Call  
                              ...
                              { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                                ...
                                /*property->property*/{ 
                                  ...
                                  { 
                                    ...
                                    { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                                      _CL_obj.Selector = Core.C_typed_copy_list
                                      /*property->property*/_CL_obj.Args = MakeConstantList(ANY(Core.F_CALL(C_range,ARGS(_Za.ToEID()))),ANY(Core.F_CALL(C_length,ARGS(ToTable(_Za).Graph.ToEID()))),ANY(Core.F_CALL(C_default,ARGS(_Za.ToEID()))))
                                      /*list->list*/v_bag_arg = _CL_obj.Id()
                                      } 
                                    va_arg2.AddFast(v_bag_arg)} 
                                  va_arg1.Args = va_arg2
                            ...
                            _Zl2 = _Zl2.AddFast(arg_20.Id())/*t=any,s=list*/
                            } 
                          { var arg_21 *ClaireObject  
                            _ = arg_21
                            if (e.Isa.IsIn(C_lambda) == CTRUE) { 
                              { var g0315 *ClaireLambda   = ToLambda(e)
                                _ = g0315
                                { var _CL_obj *Language.For   = Language.To_For(new(Language.For).Is(Language.C_For))
                                  _CL_obj.ClaireVar = To_Variable(a.At(2-1))
                                  /*Variable->Variable*/_CL_obj.SetArg = s1.Id()
                                  /*any->any*/{ 
                                    var va_arg1 *Language.Iteration  
                                    var va_arg2 *ClaireAny  
                                    va_arg1 = Language.To_Iteration(_CL_obj.Id())
                                    { var _CL_obj *Language.For   = Language.To_For(new(Language.For).Is(Language.C_For))
                                      ...
                                      /*Variable->Variable*/_CL_obj.SetArg = s2.Id()
                                      /*any->any*/{ 
                                        var va_arg1 *Language.Iteration  
                                        var va_arg2 *ClaireAny  
                                        va_arg1 = Language.To_Iteration(_CL_obj.Id())
                            ...
                            _Zl2 = _Zl2.AddFast(arg_21.Id())/*t=any,s=list*/
                            } 
                          Result = EID{_Zl2.Id(),0}
                          }
                          } 
                    ...
                    { var arg_22 *Language.Call  
                      ...
                      { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                        _CL_obj.Selector = C_put
                        /*property->property*/_CL_obj.Args = MakeConstantList(C_default.Id(),_Zv.Id(),ANY(Core.F_CALL(C_default,ARGS(_Za.ToEID()))))
                        /*list->list*/arg_22 = _CL_obj
                        } 
                      _Zl2 = _Zl2.AddFast(arg_22.Id())/*t=any,s=list*/
                      } 
                    C_OPT.Objects = C_OPT.Objects.AddFast(_Za)/*t=any,s=list*/
                    /*list->list*/Core.F_CALL(C_Optimize_c_register,ARGS(_Za.ToEID()))
                      ...
                      { var _CL_obj *Language.Do   = Language.To_Do(new(Language.Do).Is(Language.C_Do))
                        ...
                        { 
                          ...
                          { var arg_26 *Language.Call  
                            ...
                            { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                              _CL_obj.Selector = C_Compile_object_I
                              /*property->property*/_CL_obj.Args = MakeConstantList(ANY(Core.F_CALL(C_name,ARGS(_Za.ToEID()))),C_table.Id())
                              /*list->list*/arg_26 = _CL_obj
                              } 
                            { var arg_27 *ClaireList  
                              ...
                              /* ERROR PROTECTION INSERTED (arg_27-try_25) */
...
/* {1} The go function for: Compile/compute_if_write_inverse(R:relation) [status=1] */
func F_Compile_compute_if_write_inverse_relation (R *ClaireRelation ) EID { 
    ...
    { var x *ClaireVariable  
      { var _CL_obj *ClaireVariable   = To_Variable(new(ClaireVariable).Is(C_Variable))
        ...
        /*symbol->symbol*/_CL_obj.Range = R.Domain
        /*type->type*/x = _CL_obj
        } 
      { var y *ClaireVariable  
        ...
        { var z *ClaireVariable  
          { var _CL_obj *ClaireVariable   = To_Variable(new(ClaireVariable).Is(C_Variable))
            ...
            /*symbol->symbol*/_CL_obj.Range = R.Range
            /*type->type*/z = _CL_obj
            } 
            ...
            if (R.Multivalued_ask == CTRUE) { 
              ...
              if (R.Inverse.Id() != CNULL) { 
                ...
                { var arg_4 *ClaireAny  
                  ...
                  arg_4 = ANY(try_5)
                  try_3 = EID{l1.AddFast(arg_4).Id(),0}/*t=any,s=EID*/
                  }
                  } 
                /* ERROR PROTECTION INSERTED (l1-Result) */
                if ErrorIn(try_3) {Result = try_3
                  ...
                  { var _CL_obj *Language.If   = Language.To_If(new(Language.If).Is(Language.C_If))
                    ...
                    { 
                      ...
                      { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                        ...
                        /*property->property*//*g_try(v2:"try_9",loop:false) */
                        { 
                          var va_arg1 *Language.Call  
                          var va_arg2 *ClaireList  
                          va_arg1 = _CL_obj
                          ...
                          { 
                            ...
                            { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                              ...
                              /*property->property*//*g_try(v2:"try_11",loop:false) */
                              { 
                                var va_arg1 *Language.Call  
                                var va_arg2 *ClaireList  
                                va_arg1 = _CL_obj
                                ...
                                va_arg1.Args = va_arg2
                                /*list->list*/try_11 = EID{va_arg2.Id(),0}
                                }
                                } 
              ...
              if (R.Inverse.Id() != CNULL) { 
                ...
                { var arg_17 *Language.If  
                  ...
                  { var _CL_obj *Language.If   = Language.To_If(new(Language.If).Is(Language.C_If))
                    { 
                      ...
                      { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                        ...
                        /*property->property*/_CL_obj.Args = MakeConstantList(z.Id())
                        /*list->list*/va_arg2 = _CL_obj.Id()
                        } 
                      va_arg1.Test = va_arg2
                      /*any->any*/} 
                    ...
                    { 
                      ...
                      /* ERROR PROTECTION INSERTED (va_arg2-try_18) */
                      if ErrorIn(try_19) {try_18 = try_19
                      } else {
                      va_arg2 = ANY(try_19)
                      va_arg1.Arg = va_arg2
                      /*any->any*/try_18 = va_arg2.ToEID()
                      }
                      } 
                  ...
                  try_16 = EID{l1.AddFast(arg_17.Id()).Id(),0}/*t=any,s=EID*/
                  }
                  } 
                /* ERROR PROTECTION INSERTED (l1-Result) */
                ...
                { var arg_21 *ClaireAny  
                  ...
                  arg_21 = ANY(try_22)
                  try_20 = EID{l1.AddFast(arg_21).Id(),0}/*t=any,s=EID*/
                  }
                  } 
                /* ERROR PROTECTION INSERTED (l1-Result) */
              ...
              { 
                ...
                { var arg_24 *Language.Let  
                  ...
                  { var _CL_obj *Language.Let   = Language.To_Let(new(Language.Let).Is(Language.C_Let))
                    _CL_obj.ClaireVar = z
                    /*Variable->Variable*//*g_try(v2:"try_25",loop:false) */
                    { 
                      var va_arg1 *Language.Let  
                      var va_arg2 *ClaireAny  
                      va_arg1 = _CL_obj
                    ...
                    { 
                      ...
                      { var _CL_obj *Language.If   = Language.To_If(new(Language.If).Is(Language.C_If))
                        { 
                          ...
                          { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                            _CL_obj.Selector = ToProperty(Core.C__I_equal.Id())
                            /*property->property*/_CL_obj.Args = MakeConstantList(y.Id(),z.Id())
                            /*list->list*/va_arg2 = _CL_obj.Id()
                            } 
                          va_arg1.Test = va_arg2
                          /*any->any*/} 
...
/* {1} The go function for: Compile/compute_set_write(R:relation) [status=1] */
func F_Compile_compute_set_write_relation (R *ClaireRelation ) EID { 
    ...
    { var x *ClaireVariable  
      ...
      { var y *ClaireVariable  
        ...
        { var _CL_obj *ClaireVariable   = To_Variable(new(ClaireVariable).Is(C_Variable))
          _CL_obj.Pname = Core.F_symbol_I_string2(MakeString("YY"))
          /*symbol->symbol*/_CL_obj.Range = ToType(C_bag.Id())
          /*type->type*/y = _CL_obj
          } 
        { var z *ClaireVariable  
          _ = z
          { var _CL_obj *ClaireVariable   = To_Variable(new(ClaireVariable).Is(C_Variable))
            _CL_obj.Pname = Core.F_symbol_I_string2(MakeString("ZZ"))
            /*symbol->symbol*/_CL_obj.Range = Core.F_member_type(R.Range)
            /*type->type*/z = _CL_obj
            } 
          { var l1 *ClaireList   = ToType(C_any.Id()).EmptyList()
            _ = l1
            ...
            if (R.Inverse.Id() != CNULL) { 
              ...
              { var arg_2 *Language.For  
                ...
                { var _CL_obj *Language.For   = Language.To_For(new(Language.For).Is(Language.C_For))
                  _CL_obj.ClaireVar = z
                  /*Variable->Variable*//*g_try(v2:"try_3",loop:false) */
                  { 
                    var va_arg1 *Language.Iteration  
                    var va_arg2 *ClaireAny  
                    va_arg1 = Language.To_Iteration(_CL_obj.Id())
                ...
                try_1 = EID{l1.AddFast(arg_2.Id()).Id(),0}/*t=any,s=EID*/
                }
                } 
              /* ERROR PROTECTION INSERTED (l1-Result) */
              if ErrorIn(try_1) {Result = try_1
            ...
            { var arg_7 *ClaireAny  
              ...
              arg_7 = ANY(try_8)
              try_6 = EID{l1.AddFast(arg_7).Id(),0}/*t=any,s=EID*/
              }
              } 
            /* ERROR PROTECTION INSERTED (l1-Result) */
            if ErrorIn(try_6) {Result = try_6
            ...
            { var arg_10 *Language.For  
              ...
              { var _CL_obj *Language.For   = Language.To_For(new(Language.For).Is(Language.C_For))
                _CL_obj.ClaireVar = z
                /*Variable->Variable*/_CL_obj.SetArg = y.Id()
                /*any->any*//*g_try(v2:"try_11",loop:false) */
                { 
                  var va_arg1 *Language.Iteration  
                  var va_arg2 *ClaireAny  
                  va_arg1 = Language.To_Iteration(_CL_obj.Id())
              ...
              try_9 = EID{l1.AddFast(arg_10.Id()).Id(),0}/*t=any,s=EID*/
              }
              } 
            /* ERROR PROTECTION INSERTED (l1-Result) */
            if ErrorIn(try_9) {Result = try_9
            ...
            { var dn *ClaireString   = F_append_string(R.Name.String_I(),MakeString("_set_write"))
              ...
              { var arg_13 *ClaireLambda  
                ...
                var try_14 EID 
                /*g_try(v2:"try_14",loop:false) */
                { var arg_15 *Language.Do  
                  _ = arg_15
                  { var _CL_obj *Language.Do   = Language.To_Do(new(Language.Do).Is(Language.C_Do))
                    _CL_obj.Args = l1
                    /*list->list*/arg_15 = _CL_obj
                    } 
                  try_14 = Language.F_lambda_I_list(MakeConstantList(x.Id(),y.Id()),arg_15.Id())
                  } 
...
/* {1} The go function for: Produce_put(r:property,x:Variable,y:any) [status=1] */
      ...
      { 
        ...
        for _,xs_iter = range(r.Restrictions.ValuesO()){ 
          ...
          if ((C_slot.Id() == xs.Isa.Id()) && 
                        ...
                        { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                          ...
                          /*property->property*/{ 
                            ...
                            { 
                              ...
                              { var _CL_obj *Language.Cast   = Language.To_Cast(new(Language.Cast).Is(Language.C_Cast))
                                _CL_obj.Arg = x.Id()
                                /*any->any*/_CL_obj.SetArg = ToType(Core.F_domain_I_restriction(xs).Id())
                                /*type->type*/v_bag_arg = _CL_obj.Id()
                                } 
                              va_arg2.AddFast(v_bag_arg)} 
                            va_arg1.Args = va_arg2
            ...
            /* ERROR PROTECTION INSERTED (l-loop_1) */
            if ErrorIn(try_2) {loop_1 = try_2
            } else {
            l = ToList(OBJ(try_2))
            loop_1 = EID{l.Id(),0}
...
/* {1} The go function for: Produce_erase(r:property,x:Variable) [status=1] */
func F_Optimize_Produce_erase_property (r *ClaireProperty ,x *ClaireVariable ) EID { 
    var Result EID 
    { var l *ClaireList   = ToType(C_any.Id()).EmptyList()
      { var val *ClaireBag  
        _ = val
        if (r.Multivalued_ask.Id() == C_list.Id()) { 
...
// same for a table
/* {1} The go function for: Produce_put(r:table,x:Variable,y:any) [status=0] */
        ...
        { 
          ...
          if (r.Multivalued_ask == CTRUE) { 
            { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
              ...
              /*property->property*/_CL_obj.Args = MakeConstantList(MakeConstantList(C_nth.Id(),MakeConstantList(r.Id(),x.Id()).Id()).Id(),y)
              /*list->list*/v_bag_arg = _CL_obj.Id()
              } 
            } else {
            v_bag_arg = y
...
/* {1} The go function for: Produce_get(r:relation,x:Variable) [status=1] */
func F_Optimize_Produce_get_relation (r *ClaireRelation ,x *ClaireVariable ) EID { 
    var Result EID 
    if (C_table.Id() == r.Isa.Id()) { 
      { var g0317 *ClaireTable   = ToTable(r.Id())
        _ = g0317
        { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
          _CL_obj.Selector = C_nth
          /*property->property*/_CL_obj.Args = MakeConstantList(g0317.Id(),x.Id())
          /*list->list*/Result = EID{_CL_obj.Id(),0}
          } 
        } 
      }  else if (r.Isa.IsIn(C_property) == CTRUE) { 
      { var g0318 *ClaireProperty   = ToProperty(r.Id())
        _ = g0318
        { var l *ClaireList   = ToType(C_any.Id()).EmptyList()
          /*g_try(v2:"Result",loop:true) */
          { 
            ...
            var xs_iter *ClaireAny  
            Result= EID{CFALSE.Id(),0}
            for _,xs_iter = range(g0318.Restrictions.ValuesO()){ 
              xs = ToRestriction(xs_iter)
              var loop_1 EID 
              _ = loop_1
              /*g_try(v2:"loop_1",loop:tuple("Result", EID)) */
...
// generate a remove
/* {1} The go function for: Produce_remove(r:property,x:Variable,y:any) [status=1] */
            ...
            { var arg_3 *ClaireList  
              ...
              { 
                ...
                if (r.Multivalued_ask == CTRUE) { 
                  { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                    ...
                    /*property->property*/{ 
                      ...
                      { 
                        ...
                        { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                          _CL_obj.Selector = r
                          /*property->property*/_CL_obj.Args = MakeConstantList(x.Id())
                          /*list->list*/v_bag_arg = _CL_obj.Id()
                          } 
                        va_arg2.AddFast(v_bag_arg)
                        va_arg2.AddFast(y)} 
                  ...
                  { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                    _CL_obj.Selector = C_put
                    /*property->property*/_CL_obj.Args = MakeConstantList(r.Id(),x.Id(),CNULL)
                    /*list->list*/v_bag_arg = _CL_obj.Id()
                    } 
                  } 
                arg_3.AddFast(v_bag_arg)} 
...
// same for a table
/* {1} The go function for: Produce_remove(r:table,x:Variable,y:any) [status=0] */
        ...
        { var ad *ClaireType   = ToType(CEMPTY.Id())
          { var ar *ClaireType   = ToType(CEMPTY.Id())
            { 
              ...
              _ = s
              var s_iter *ClaireAny  
              for _,s_iter = range(g0319.Restrictions.ValuesO()){ 
                ...
                if (C_slot.Id() == s.Isa.Id()) { 
                  ...
                  { var arg_1 *ClaireType  
                    _ = arg_1
                    if (g0319.Multivalued_ask == CTRUE) { 
            ...
            g0319.Open = 1
            /*integer->integer*/if (Equal(ad.Id(),CEMPTY.Id()) != CTRUE) { 
              g0319.Domain = ToType(ad.Class_I().Id())
              /*type->type*/{ 
                var va_arg1 *ClaireRelation  
                var va_arg2 *ClaireType  
                va_arg1 = ToRelation(g0319.Id())
                if (g0319.Multivalued_ask.Id() == C_list.Id()) { 
                  va_arg2 = Core.F_param_I_class(C_list,ToType(ar.Class_I().Id()))
                  }  else if (g0319.Multivalued_ask.Id() == C_set.Id()) { 
...
/* {1} The go function for: Compile/Tighten!(r:relation) [status=0] */
...
/* {1} The go function for: Compile/lexical_num(self:any,n:integer) [status=1] */
func F_Compile_lexical_num_any (self *ClaireAny ,n int) EID { 
    var Result EID 
    if (self.Isa.IsIn(Language.C_Call) == CTRUE) { 
      { var g0320 *Language.Call   = Language.To_Call(self)
        _ = g0320
        Result = F_Compile_lexical_num_any(g0320.Args.Id(),n)
        } 
      }  else if (self.Isa.IsIn(C_Instruction) == CTRUE) { 
      { var g0321 *ClaireInstruction   = To_Instruction(self)
        { var _Ztype *ClaireClass   = g0321.Isa
          /*g_try(v2:"Result",loop:true) */
          if (Language.C_Instruction_with_var.Descendents.Contain_ask(_Ztype.Id()) == CTRUE) { 
            /*g_try(v2:"Result",loop:true) */
            Result = Core.F_put_property2(C_mClaire_index,ToObject(OBJ(Core.F_CALL(Language.C_var,ARGS(EID{g0321.Id(),0})))),MakeInteger(n).Id())
            /* ERROR PROTECTION INSERTED (Result-Result) */
            if !ErrorIn(Result) {
            n = (n+1)
          ...
          { 
            ...
            for _,s_iter = range(_Ztype.Slots.ValuesO()){ 
              ...
              loop_2 = F_Compile_lexical_num_any(Core.F_get_slot(s,ToObject(g0321.Id())),n)
      ...
      { var g0322 *ClaireBag   = ToBag(self)
        _ = g0322
        { 
          var x *ClaireAny  
          _ = x
          ...
          var try_3 EID 
          /*g_try(v2:"try_3",loop:false) */
          try_3 = Core.F_enumerate_any(g0322.Id())
...
// v3.2 -----------------------------------------------------------------
/* {1} The go function for: c_type(self:Defrule) [status=0] */
...
/* {1} The go function for: c_code(self:Defrule,s:class) [status=1] */
func F_c_code_Defrule (self *Language.Defrule ,s *ClaireClass ) EID { 
    ...
    { var ru *ClaireAny   = self.Ident.Get()
      { var l *ClaireList   = ToType(C_any.Id()).EmptyList()
          ...
          for i_it := 0; i_it < r_support.Count; i_it++ { 
            ...
            if (INT(Core.F_CALL(C_open,ARGS(r.ToEID()))) < 2) { 
              { var arg_2 *Language.Call  
                ...
                { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                  ...
                  /*property->property*/_CL_obj.Args = MakeConstantList(r)
                  /*list->list*/arg_2 = _CL_obj
                  } 
                l = l.AddFast(arg_2.Id())/*t=any,s=list*/
                } 
              } 
            /*g_try(v2:"loop_1",loop:tuple("Result", EID)) */
            ...
            { var dn *ClaireAny   = ANY(Core.F_CALL(ToProperty(C__7_plus.Id()),ARGS(Core.F_CALL(C_name,ARGS(r.ToEID())),EID{MakeString("_write").Id(),0})))
              ...
              { var s *ClaireString  
                ...
                /* ERROR PROTECTION INSERTED (s-loop_1) */
                if ErrorIn(try_3) {loop_1 = try_3
                } else {
                s = ToString(OBJ(try_3))
                { var lb *ClaireAny   = ANY(Core.F_CALL(C_if_write,ARGS(r.ToEID())))
                  Core.F_tformat_string(MakeString("################ the if-write is ~S \n"),0,MakeConstantList(lb))
                  /*g_try(v2:"loop_1",loop:tuple("Result", EID)) */
                  ...
                  { var arg_4 *Language.Call  
                    ...
                    { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                      _CL_obj.Selector = C_put
                      /*property->property*/_CL_obj.Args = MakeConstantList(C_if_write.Id(),r,F_Optimize_demon_function_string(s).Id())
                      /*list->list*/arg_4 = _CL_obj
                      } 
                    loop_1 = EID{l.AddFast(arg_4.Id()).Id(),0}/*t=any,s=EID*/
                    } 
                  }
                  } 
                }
          ...
          for i_it := 0; i_it < r_support.Count; i_it++ { 
            ...
            if (Language.F_eventMethod_ask_relation2(ToRelation(r)) == CTRUE) { 
              ...
              { var arg_7 *ClaireAny  
                ...
                arg_7 = ANY(try_8)
                try_6 = EID{l.AddFast(arg_7).Id(),0}/*t=any,s=EID*/
                }
                } 
              /* ERROR PROTECTION INSERTED (l-loop_5) */
            ...
            /* ERROR PROTECTION INSERTED (loop_5-Result) */
        ...
        /* ERROR PROTECTION INSERTED (Result-Result) */
        if !ErrorIn(Result) {
        { var arg_9 *Language.Do  
          _ = arg_9
          { var _CL_obj *Language.Do   = Language.To_Do(new(Language.Do).Is(Language.C_Do))
            _CL_obj.Args = l
            /*list->list*/arg_9 = _CL_obj
            } 
          Result = Core.F_CALL(C_c_code,ARGS(EID{arg_9.Id(),0},EID{s.Id(),0}))
          } 
        }}
        } 
      } 
...
/* {1} The go function for: compile_if_write(R:relation) [status=1] */
func F_Optimize_compile_if_write_relation (R *ClaireRelation ) EID { 
    var Result EID 
    /*g_try(v2:"Result",loop:true) */
    PRINC("compile_if_write(")
    /*g_try(v2:"Result",loop:true) */
    ...
    PRINC(") l = ")
    /*g_try(v2:"Result",loop:true) */
    Result = Core.F_print_any(Core.F_get_table(Language.C_demons,R.Id()))
    /* ERROR PROTECTION INSERTED (Result-Result) */
    if !ErrorIn(Result) {
    PRINC(", lvar = ")
    /*g_try(v2:"Result",loop:true) */
    Result = Core.F_print_any(Language.ToLanguageDemon(ToList(Core.F_get_table(Language.C_demons,R.Id())).At(1-1)).Formula.Vars.Id())
    /* ERROR PROTECTION INSERTED (Result-Result) */
    if !ErrorIn(Result) {
    PRINC(" [multi:")
    /*g_try(v2:"Result",loop:true) */
    Result = Core.F_print_any(R.Multivalued_ask.Id())
    /* ERROR PROTECTION INSERTED (Result-Result) */
    if !ErrorIn(Result) {
    PRINC("]\n")
    Result = EVOID
    ...
    { var l *ClaireList   = ToList(Core.F_get_table(Language.C_demons,R.Id()))
      { var lvar *ClaireList   = Language.ToLanguageDemon(l.ValuesO()[1-1]).Formula.Vars
        { var l1 *ClaireList  
          var try_1 EID 
          /*g_try(v2:"try_1",loop:false) */
          { 
            ...
            var try_2 EID 
            /*g_try(v2:"try_2",loop:false) */
            try_2 = Core.F_CALL(C_Optimize_Produce_put,ARGS(EID{R.Id(),0},lvar.At(1-1).ToEID(),lvar.At(2-1).ToEID()))
            /* ERROR PROTECTION INSERTED (v_bag_arg-try_1) */
            if ErrorIn(try_2) {try_1 = try_2
            } else {
            v_bag_arg = ANY(try_2)
          ...
          { var l2 *ClaireList  
            { 
              ...
              for CLcount := 0; CLcount < v_list6.Length(); CLcount++{ 
                x = Language.ToLanguageDemon(v_list6.At(CLcount))
                v_local6 = F_Optimize_demon_substitution_demon(x,lvar)
            ...
            PRINC(">>>>>>>>>> vars = ")
            /*g_try(v2:"Result",loop:true) */
            Result = Core.F_CALL(C_print,ARGS(lvar.At(1-1).ToEID()))
            /* ERROR PROTECTION INSERTED (Result-Result) */
            if !ErrorIn(Result) {
            PRINC(":")
            /*g_try(v2:"Result",loop:true) */
            Result = Core.F_print_any(R.Domain.Id())
            /* ERROR PROTECTION INSERTED (Result-Result) */
            if !ErrorIn(Result) {
            PRINC(" and ")
            /*g_try(v2:"Result",loop:true) */
            Result = Core.F_CALL(C_print,ARGS(lvar.At(2-1).ToEID()))
            /* ERROR PROTECTION INSERTED (Result-Result) */
            if !ErrorIn(Result) {
            PRINC(":")
            /*g_try(v2:"Result",loop:true) */
            Result = Core.F_print_any(R.Range.Id())
            /* ERROR PROTECTION INSERTED (Result-Result) */
            if !ErrorIn(Result) {
            PRINC("   <<<<<<<<<<<<<\n")
            Result = EVOID
            ...
            if ((l2.At(1-1).Isa.IsIn(Language.C_If) == CTRUE) && 
              ...
              if (Core.F_owner_any(Language.To_If(l2.At(1-1)).Test).IsIn(Language.C_And) == CTRUE) { 
                { 
                  var va_arg1 *Language.If  
                  var va_arg2 *ClaireAny  
                  ...
                  { var _CL_obj *Language.And   = Language.To_And(new(Language.And).Is(Language.C_And))
                    ...
                    { 
                      ...
                      var try_5 EID 
                      /*g_try(v2:"try_5",loop:false) */
                      try_5 = ToList(OBJ(Core.F_CALL(C_args,ARGS(Language.To_If(l2.At(1-1)).Test.ToEID())))).Cdr()
                      /* ERROR PROTECTION INSERTED (va_arg2-try_4) */
                      if ErrorIn(try_5) {try_4 = try_5
                      } else {
                      va_arg2 = ToList(OBJ(try_5))
            ...
            if (R.Inverse.Id() != CNULL) { 
              ...
              if (R.Multivalued_ask != CTRUE) { 
                ...
                { var arg_7 *ClaireAny  
                  ...
                  var try_8 EID 
                  /*g_try(v2:"try_8",loop:false) */
                  try_8 = Core.F_CALL(C_Optimize_Produce_remove,ARGS(EID{R.Inverse.Id(),0},lvar.At(3-1).ToEID(),lvar.At(1-1).ToEID()))
                  /* ERROR PROTECTION INSERTED (arg_7-try_6) */
                  if ErrorIn(try_8) {try_6 = try_8
                  } else {
                  arg_7 = ANY(try_8)
              ...
              { var arg_10 *ClaireAny  
                ...
                var try_11 EID 
                /*g_try(v2:"try_11",loop:false) */
                try_11 = Core.F_CALL(C_Optimize_Produce_put,ARGS(EID{R.Inverse.Id(),0},lvar.At(2-1).ToEID(),lvar.At(1-1).ToEID()))
                /* ERROR PROTECTION INSERTED (arg_10-try_9) */
                if ErrorIn(try_11) {try_9 = try_11
                } else {
                arg_10 = ANY(try_11)
                try_9 = EID{l1.AddFast(arg_10).Id(),0}/*t=any,s=EID*/
                }
                } 
              /* ERROR PROTECTION INSERTED (l1-Result) */
              if ErrorIn(try_9) {Result = try_9
            ...
            { 
              ...
              { var arg_13 *Language.ComplexInstruction  
                ...
                if (Language.F_eventMethod_ask_relation2(R) == CTRUE) { 
                  { var _CL_obj *Language.Do   = Language.To_Do(new(Language.Do).Is(Language.C_Do))
                    _CL_obj.Args = l2
                    /*list->list*/arg_13 = Language.To_ComplexInstruction(_CL_obj.Id())
                    } 
                      ...
                      { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                        ...
                        /*property->property*/{ 
                          ...
                          { 
                            ...
                            { var _CL_obj *Language.Call   = Language.To_Call(new(Language.Call).Is(Language.C_Call))
                              _CL_obj.Selector = ToProperty(C__Z.Id())
                              /*property->property*/_CL_obj.Args = MakeConstantList(lvar.At(2-1),Language.F_readCall_relation(R,lvar.At(1-1)).Id())
                              /*list->list*/v_bag_arg = _CL_obj.Id()
                              } 
                            va_arg2.AddFast(v_bag_arg)} 
                          va_arg1.Args = va_arg2
                  ...
                  { var _CL_obj *Language.Let   = Language.To_Let(new(Language.Let).Is(Language.C_Let))
                    ...
                    /*Variable->Variable*/_CL_obj.Value = Language.F_readCall_relation(R,lvar.At(1-1)).Id()
                    /*any->any*/{ 
                      var va_arg1 *Language.Let  
                      var va_arg2 *ClaireAny  
                      va_arg1 = _CL_obj
                ...
                try_12 = Language.F_lambda_I_list(MakeConstantList(lvar.At(1-1),lvar.At(2-1)),arg_13.Id())
                } 
              /* ERROR PROTECTION INSERTED (va_arg2-Result) */
...
/* {1} The go function for: demon_substitution(x:Language/demon,lvar:list) [status=0] */
...
var Result *ClaireAny  
    { var y *ClaireAny  
      _ = y
      if (lvar.Length() > 2) { 
        y = Language.F_substitution_any(x.Formula.Body,To_Variable(x.Formula.Vars.At(3-1)),lvar.At(3-1))
        } else {
        y = x.Formula.Body
        } 
      Result = Language.F_substitution_any(Language.F_substitution_any(y,To_Variable(x.Formula.Vars.At(1-1)),lvar.At(1-1)),To_Variable(x.Formula.Vars.At(2-1)),lvar.At(2-1))
      } 
    return Result} 
...
/* {1} The go function for: demon_function(%name:string) [status=0] */
func F_Optimize_demon_function_string (_Zname *ClaireString ) *ClaireFunction  { 
    // procedure body with s = function 
...
/* {1} The go function for: compileEventMethod(p:property) [status=1] */
