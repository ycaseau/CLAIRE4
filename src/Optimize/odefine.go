    ...
    { var lp *ClaireList
      ...
      { var n int = lp.Length()
        ...
        { 
          ...
          if (v_and4 == CFALSE) {g0298I = CFALSE
          } else { 
            { var arg_2 *ClaireAny
              { var i int = 2
                { var g0296 int = n
        ...
        if (_Zbody.Isa.IsIn(Language.C_Call) == CTRUE) { 
          { var g0314 *Language.Call = Language.To_Call(_Zbody)
            { 
              ...
              v_and6 = Equal(g0314.Selector.Id(),Core.C_sort.Id())
                ...
                { var a1 *ClaireAny = g0314.Args.At(0)
                  if (a1.Isa.IsIn(Language.C_Call) == CTRUE) { 
                    { var g0315 *Language.Call = Language.To_Call(a1)
                      v_and6 = MakeBoolean((g0315.Selector.Id() == Core.C__at.Id()) && (g0315.Args.At(0).Isa.IsIn(C_property) == CTRUE))
                      } 
                    } else {
                    v_and6 = CFALSE
                    } 
