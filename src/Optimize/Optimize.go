...
func MetaLoad() { 
  ...
  C_compiler.Version = MakeFloat(0.02).Id()
  ...
  C_OPT.SimpleOperations = MakeSet(ToType(C_property.Id()),Core.C__plus.Id(),
    ...
    C__7.Id(),
    C__star.Id())
  C_OPT.NonIdentifiableSet = MakeSet(ToType(C_class.Id()),C_any.Id(),
  ...
  Core.F_attach_method(C_safe.AddMethod(Signature(C_any.Id(),C_any.Id()),0,MakeFunction1(E_safe_any,"safe_any")),MakeString("osystem.cl:199")).Typing = MakeFunction1(E_safe_any_type,"safe_any_type").Id()
