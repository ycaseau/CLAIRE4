// ==================================================================
// Goloang CLAIRE4 Kernel - Copyright (C) Yves Caseau 2020-2025
// started on June 21st, 2020
// see ClLernel.go for disclosure
// clBag.go
// ==================================================================
...
// write onto l[i] --------------------------------------------------------------
// needed by the compiler : rewrites an object value at position i, independently of the type representation
